...
from altcoin.settings.base import get_coin_env_var, get_url, proxy, get_env_var
...
class LitecoindClient(BaseClient):
    ...
    def walletpassphrase(self):
        return self.proxy.walletpassphrase(get_coin_env_var('LTC','walletpassphrase'),60)
